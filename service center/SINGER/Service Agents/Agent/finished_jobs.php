...
<!DOCTYPE html>
<html>
<title>Service Center Agent</title>
 <meta charset="utf-8">
...
<nav class="w3-sidebar w3-bar-block w3-card w3-pale-green" id="mySidebar" style="z-index:3;width:250px;font-weight:bold;">

<div class="w3-container w3-theme-d5">
  <span onclick="closeSidebar()" class="w3-button w3-display-topright w3-large">X</span>
  <br><br>
  <div class="w3-padding w3-center">
    <img class="w3-circle" src="img/agent.jpg" alt="" style="width:100%">
  </div>
 ...
 <link rel="stylesheet" type="text/css" href="employee service.css">
  ...
  <?php
                ...
                $id=$_SESSION['id'] ;
                    ...
                    $sql1 = "select * from job,product  where job.current_situation='Finished' and job.serial_no=product.serial_number and product.location='Service Center' and job.job_type='Home visit' and job.service_agent='$id' and job.center_id='$cid' ORDER BY job_no DESC";
                    ...
                    include("finished_jobs_display.php");
                    }else{
                      echo" <div class='jumbotron jumbotron-fluid'  style='margin-top:90px'>
                              <div class='container'>
                                <h2 class='text-danger'> SINGER <small class='text-primary'> Service</small></h2>      
                                <p>Not Available Finished Jobs</p>
                              </div>
                            </div>";
                    }
