...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="css/products-received.css">
</head>
<body>
    ...
    <div class="row content">
      <div class="col-sm-2 ">
        ...
        <div class="card" style="auto;">
          ...
          <li class="nav-item">
              ...
              <br>
            <li class="nav-item">
                <a class="nav-link" href="products-sent.php">
				<span style="font-size: 20px;color:rgb(100, 2, 87);">
              ...
              <br>
            <li class="nav-item">
              <a class="nav-link active" href="products-received.php">
      ...
      <div class="col-sm-10">
        <div class="card bg-light text-dark"style="height:50px;">
          <div class="card-body"><p id="p1">Products / Received</p></div>
        </div>
        <br>
        <?php
          include("conni.php");
          mysqli_select_db($conn,"cs2018g2"); 
          $sql = "SELECT * from product where location='Showroom' AND delivery='Service Center'";
          ...
          include("p_received_display.php");
          }else{
