                          ...
                          <div class='modal-dialog'>
                            <div class='modal-content'>
                              ...
                              <div class='modal-body'>";
                                ...
                                echo"<form action='handoverproduct.php'method='POST'> 
                                  ...
                                  <button type='submit' name='btnEnter' value='' class='btn btn-secondary' align='text-center'>Handover To Customer</button>
                                      </form>
                                  </div> 
