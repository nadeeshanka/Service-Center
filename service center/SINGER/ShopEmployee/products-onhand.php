...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="css/products-onhand.css">
</head>
<body>
    ...
    <div class="row content">
      <div class="col-sm-2 ">
        ...
        <div class="card" style="width:auto;">
          ...
          <li class="nav-item">
                <a class="nav-link active" href="products-onhand.php">
      ...
      <div class="col-sm-10">
        <div class="card bg-light text-dark"style="height:50px;">
          <div class="card-body"><p id="p1">Products / On-Hand</p></div>
        </div>
        <br>
        <?php
          include("conni.php");
          mysqli_select_db($conn,"cs2018g2"); 
          $sql = "SELECT * FROM product WHERE location='Showroom' AND delivery='Showroom'";
