...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="css/products-handover.css">
</head>
<body>
    ...
    <div class="row content">
      <div class="col-sm-2 ">
        ...
        <div class="card" style="auto;">
          ...
          <li class="nav-item">
            ...
            <br>
            <li class="nav-item">
                <a class="nav-link active" href="products-handover.php">
      ...
      <div class="col-sm-10">
        ...
        <?php
          ...
          $sql = "select * from product where delivery='Handed_to_Customer' ";
          ...
          include("p_handover_display.php");
          }else{
