      ...
      <div class="col-sm-2 ">
        ...
        <div class="card" style="width:auto;">
          ...
          <ul class="nav flex-column nav-pills">
            <li class="nav-item">
              <a class="nav-link active" href="payment_bills.php">
                <span style="font-size: 25px;">
                <i class="fas fa-file-invoice-dollar"></i>
                </span>  
                <span style="font-size:18px;">Unpaid Bills</span>
              </a>
            </li>
              <br>
        
            <li class="nav-item">
              <a class="nav-link " href="payment_paidbills.php">
              <span style="font-size: 25px;color:rgb(210,120,0);">
              <i class="fas fa-clipboard-check"></i>
               </span>
               <span style="font-size:18px;color:rgb(0,0,0);">Paid Bills</span>
              </a>
            </li>
          </ul>
        
         <div class="card-body">
            <p class="card-text" id="p2">Enter Job Number to search payment details to relevant job..</p>

            <form  class="form-inline float-right" method="POST" id="searchform">
              <div class="input-group">
                <input class="form-control "type="text" name="find" id="find" placeholder="JO-Number..." required>
              </div> 
            </form>
            
              <button class="btn btn-danger" type="submit" id="btnsearch"><span style="font-size:18px;"><i class="fas fa-search"></i></span></button>
  ...
  <div  class="col-sm-10">
    <div id="normal">
      <div class="card bg-light text-dark" style="height:50px;">
        <div class="card-body"> 
          <p id="p1">Payments / Unpaid Bills</p>
        </div>
      </div>
      <div id="space"></div>
            ...
            <?php
                ...
                $cid=$_SESSION['USERNAME'];
                    ...
                    $sql1 = "select * from bill where center_id='$cid' and status='Not Paid' ORDER BY job_no DESC  ";
