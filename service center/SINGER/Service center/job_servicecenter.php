...
<body >
      ...
      <div class="col-sm-2 ">
        ...
        <div class="card" style="width:auto;">
          ...
          <ul class="nav flex-column nav-pills">
            <li class="nav-item">
              <a class="nav-link active " href="job_servicecenter.php">
                <span style="font-size: 25px;">
                <i class="fas fa-users-cog"></i>
                </span>  
                <span style="font-size:18px;">On Our Hand</span>
              </a>
            </li>
              <br>
            <li class="nav-item">
  ...
  <div  class="col-sm-10">
      <div class="card bg-light text-dark"style="height:50px;">
        <div class="card-body"> 
          <p id="p1">Current Jobs / On Our Hand</p>
        </div>
      </div>
      <div id="space"></div>
            ...
            <?php
              ...
              $sql1 = "select * from job where job_type='Service Center' and center_id='$cid' and (current_situation='Processing' or current_situation='')  ORDER BY job_no DESC  ";
                    $result=mysqli_query($conn,$sql1);
                    if(!$result){
                        die("Inavlid query".mysqli_error($conn)); 
                    }
                    if(mysqli_num_rows($result) > 0){
                    include("job_servicecenter_display.php");
                    }else{
                      echo "
