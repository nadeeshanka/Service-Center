...
<body >
        ...
        <div class="card" style="width:auto;">
          ...
          <ul class="nav flex-column nav-pills">
            <li class="nav-item">
              ...
              <br>
            <li class="nav-item">
              <a class="nav-link " href="job_homevisit.php">
              <span style="font-size: 25px;color:rgb(204,0,102);">
              <i class="fas fa-home"></i> 
              </span>
               <span style="font-size:18px;color:rgb(0,0,0);">Home Visit </span>
            ...
            <br>
            <li class="nav-item">
              <a class="nav-link active" href="job_replacement.php">
              <span style="font-size: 25px;">
              <i class="fas fa-cart-arrow-down"></i> 
              </span>
               <span style="font-size:18px;">Replacement</span>
              </a>
            </li>
          </ul>
        </div>  
  ...
  <div  class="col-sm-10">
      <div class="card bg-light text-dark" style="height:50px;">
        <div class="card-body"> 
          <p id="p1">Current Jobs / Replaced</p>
        </div>
      </div>
      <div id="space"></div>
            ...
            <?php
                ...
                $cid=$_SESSION['USERNAME'];
                    ...
                    $sql1 = "select * from job,product  where job.center_id='$cid' and (job.current_situation='Replace' OR job.current_situation='Replaced')  and product.location='Service Center' and job.serial_no =product.serial_number  ORDER BY job_no DESC";
