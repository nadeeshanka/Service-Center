...
<body >
    ...
    <div class="row content">
      <div class="col-sm-2 ">
        <div class="card" style="width:auto">
          ...
          <?php 
          echo"Center ID-".$_SESSION['USERNAME'];
          ?> 
        </div>
      </div>
        ...
        <div class="card" style="width:auto;">
          ...
          <ul class="nav flex-column nav-pills">
            <li class="nav-item">
              ...
              <br>
            <li class="nav-item">
              <a class="nav-link  active" href="available_complain.php">
              <span style="font-size: 25px;">
               <i class="far fa-arrow-alt-circle-down"></i> </span>
               <span style="font-size:18px;"> Available Requests</span>
              </a>
            </li>
            <br>
             <li class="nav-item">
  ...
  <div  class="col-sm-10">
      <div class="card bg-light text-dark" style="height:50px;">
        <div class="card-body"> 
          <p id="p1">Service Requests / Available</p>
        </div>
      </div>
      <div id="space"></div>
            ...
            <?php
                ...
                $cid=$_SESSION['USERNAME']; 
                    ...
                    $sql1 = "select * from complaint  where status='available' and center_id='$cid' ORDER BY complaint_no DESC  ";
                    $result=mysqli_query($conn,$sql1);
                    if(!$result){
                        die("Inavlid query".mysqli_error($conn)); 
                    }
                    if(mysqli_num_rows($result) > 0){
                    include("available_complain_display.php");
                    }else{
                      echo "
                            <div class='jumbotron jumbotron-fluid'>
                              <div class='container'>
                                <h2 class='text-danger'> SINGER <small class='text-primary'> Service</small></h2>      
                                <p>Not Available New Service Request!</p>
                              </div>
                            </div";
                    }
