...
<body >
      ...
      <div class="col-sm-2 ">
        ...
        <div class="card" style="width:auto;">
          ...
          <ul class="nav flex-column nav-pills">
            ...
            <br>
             <li class="nav-item">
              <a class="nav-link active " href="job_finished.php">
              <span style="font-size: 25px;">
                <i class="fas fa-check-square"></i>
                </span>
              <span style="font-size:18px;">Finished Job</span>
              </a>
            </li>
            <br>
            <li class="nav-item">
  ...
  <div  class="col-sm-10">
      <div class="card bg-light text-dark" style="height:50px;">
        <div class="card-body"> 
          <p id="p1">Current Jobs / Finished</p>
        </div>
      </div>
      <div id="space"></div>
            ...
            <?php
                ...
                $cid=$_SESSION['USERNAME']; 
                    ...
                    $sql1 = "select * from job,product  where job.current_situation='Finished' and job.center_id='$cid' and job.serial_no=product.serial_number and product.location='Service Center' ORDER BY job_no DESC";
