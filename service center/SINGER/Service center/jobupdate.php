...
if(isset($_POST['btnupdate'])){
    ...
    if (mysqli_num_rows($result3) > 0) {
        ...
        if($situation=="Processing"){
         ...
         elseif($situation=="Finished"){
            ...
            $msg='Your product was repaired ,Please collect your product from where you handed over (JO-'.$job.')';

             $mail="<h1 style='color:red;'>SINGER<span style='color:blue;font-size:25px;'>Service</span></h1>
                <p style= 'border: 3px solid powderblue;padding:20px;width: 450px'><span style='font-size:18px;font-weight:bold;'>Your product's job number:- JO-".$job."</span><br></br><span style='font-size:18px;'>
            Your Product was Repaired, Please Collect your product from relevant branch or Service center</span></p>";
    ...
    if(!$result){
        ...
        header("Location:job_servicecenter.php"); 
