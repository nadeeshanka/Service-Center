...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="css/admin_Backlist.css">
</head>
<body>
  ...
  <div class="container-fluid" >
    <div class="row content">
      <div class="col-sm-2 bg-light">
        ...
        <div class="card" style="width:auto;">
          <div class="card-body">
            <p class="card-text" id="p2">Please enter customer NIC number to view his or her state</p>
            <form  class="form-inline float-right" action="admin_Backlist.php" method="post">
              <div class="input-group">
              ...
              <div class="modal fade" id="myModal">
                <div class="modal-dialog">
                  ...
                  <div class="modal-header">
                    <h4 class="modal-title">Blacklist Customer</h4>
                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                 </div>
        <!-- Modal body -->
        <div class="modal-body">
          <?php 
          include("blacklistform.php");
          ?>
        ...
        <div class="card" style="width:auto;">   
          <ul class="nav flex-column nav-pills">
            ...
            <li class="nav-item">
              <a class="nav-link active" href="admin_Backlist.php">
              <span style="font-size: 20px ;"><i class="fas fa-user-lock"></i></span> Blacklist</a>
            </li>
          </ul>
        </div>
      </div>
      ...
      <?php
        ...
        if(isset($_POST['btnsearch'])){
          ...
          if (mysqli_num_rows($result) > 0) {
            include("B_Display.php");   
          }                    
          else{
             echo "<div class='jumbotron jumbotron-fluid'>
              <div class='container'>
                <h2 class='text-danger'> SINGER <small class='text-primary'> Service</small></h2>      
                <p class=text-danger>*Sorry,nothing matched your search terms. Please try again with different Serial Number.</p>
            </div>
            </div";
          }
        }
        else{
          $sql_B = "select * from blacklist ORDER BY date DESC LIMIT 8";
