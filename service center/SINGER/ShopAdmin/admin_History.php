  ...
  <div class="container-fluid" >
    <div class="row content">
      <div class="col-sm-2 bg-light">
        ...
        <div class="card" style="width:auto;">
          <div class="card-body">
            <p class="card-text" id="p2">Please enter product serial number to view history note</p>
            <form  class="form-inline float-right" action="admin_History.php" method="post">
              <div class="input-group">
                <input class="form-control "type="text" name="search" placeholder="Serial number..." required>
                <div class="input-group-btn">
      ...
      <?php
        ...
        if(isset($_POST['btnsearch'])){
          ...
          $sql1 = "SELECT * FROM product WHERE serial_number LIKE'%$search%'";
  
          $result1=mysqli_query($conn,$sql1);
          if (mysqli_num_rows($result1) > 0)
          {
            include("H_Display.php");
          ...
          $sql = "select * from product ORDER BY purchase_date DESC LIMIT 11";

          $result=mysqli_query($conn,$sql);
          if(!$result){
            die("Inavlid query".mysqli_error($conn)); 
          }
          include("H_Displaynew.php");
        }
