...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="css/LoginSite.css">
</head>
...
<div class="container">
   ...
   <p  class="text-secondary">Please enter your Email and Password</p>
    ...
    <form id="Login" action="check.php" method="post">
        ...
        <div class="forgot">
        <a href="createnew.php">Forgot password?</a>
        </div>
        <div id="msg">
    ...
    <div class="space"></div> 
         ...
         <a  href="Registation.php"><button type="button" class="btn btn-light">Not a registered Customer Sign up Now!</button></a>
